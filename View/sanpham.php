...
<main class="main">
	<div class="page-header text-center" style="background-image: url('Content/images/page-header-bg.jpg')">
		<div class="container">
			<?php
				if($ac==1){
					echo '<h1 class="page-title">Product</h1>';
				}
				if($ac==2){
					echo '<h1 class="page-title">Search Product</h1>';
				}
			?>
				...
				<div class="col-lg-9">
					...
					<nav aria-label="Page navigation">
						<ul class="pagination justify-content-center">
							<?php if ($curent_page > 1 && $page > 1) { ?>
								<li class="page-item">
									<a class="page-link page-link-prev" href="index.php?action=sanpham&page=<?php echo $curent_page - 1; ?>" aria-label="Previous" tabindex="-1" aria-disabled="true">
										<span aria-hidden="true"><i class="icon-long-arrow-left"></i></span>Prev
									</a>
								</li>
							<?php }
							for ($i = 1; $i <= $page; $i++) { ?>
								<li class="page-item active" aria-current="page"><a class="page-link" href="index.php?action=sanpham&page=<?php echo $i; ?>"><?php echo $i; ?></a></li>
							<?php }
							if ($curent_page < $page && $page > 1) { ?>
								<li class="page-item">
									<a class="page-link page-link-next" href="index.php?action=sanpham&page=<?php echo $curent_page + 1; ?>" aria-label="Next">
